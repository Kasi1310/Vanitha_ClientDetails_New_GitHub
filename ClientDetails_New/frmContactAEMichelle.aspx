<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmContactAEMichelle.aspx.cs" Inherits="ClientDetails.frmContactAEMichelle" %>
            ...
            <form class="col-lg-12" runat="server">
                ...
                <div class="col-lg-12 form-group border-info border-10" style="padding-left: 0px; padding-right: 0px; padding-top: 10px;">
                    ...
                    <div class="col-lg-12 form-group">
                        <p align='center' style='margin: 0in; text-align: center; background: #009094'><b><span style='font-size: 30.0px; color: white'>Contact AE</span></b></p>
                    </div>
                    <div class="col-lg-12 form-group">
                    ...
                    <div class="col-lg-12 form-group">
                        ...
                        <div class="col-lg-7 d-inline-block">
                            <asp:TextBox ID="txtPhoneNumber" runat="server" CssClass="form-control" Text="" MaxLength="50"
                                autocomplete="off"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-lg-12 form-group">
