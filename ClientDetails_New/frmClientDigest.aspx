<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmClientDigest.aspx.cs" Inherits="ClientDetails.frmClientDigest" %>
...
<body>
    <div class="container h-100" style="width: 740px !important;">
            ...
            <form class="col-lg-12" runat="server">
                <div class="col-lg-12 form-group border-info border-10" style="padding-left: 0px; padding-right: 0px; padding-top: 10px;">
                    ...
                    <div class="col-lg-12 form-group">
                        <p align='center' style='margin: 0in; text-align: center; background: #009094'>
                            <b><span style='font-size: 30.0px; color: white'>MEDICOUNT DIGEST 2023</span></b></p>
                    </div>
                    <div class="col-lg-12 form-group">
