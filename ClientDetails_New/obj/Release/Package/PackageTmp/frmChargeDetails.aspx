<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmChargeDetails.aspx.cs" Inherits="ClientDetails.frmChargeDetails" %>
            ...
            <form class="col-lg-12" runat="server">
                ...
                <div class="col-lg-12 form-group border-info border-10" style="padding-left: 0px; padding-right: 0px; padding-top: 10px;">
                    ...
                    <div class="col-lg-11 form-group">
                        <asp:GridView ID="gvChargeDetails" runat="server" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Company Code">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="gvlblCompanyCode" runat="server" Text='<%# Eval("CompanyCode") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Company Name">
                                    <ItemTemplate>
                                        <asp:Label ID="gvlblCompanyName" runat="server" Text='<%# Eval("CompanyName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Mail ID">
                                    <ItemTemplate>
                                        <asp:Label ID="gvlblMailID" runat="server" Text='<%# Eval("MailID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Is Mail Send">
                                    <ItemTemplate>
