...
namespace ClientDetails.App_Code
{
    public class clsWebinarSurvey
    {
        ...
        public void InsertWebinarSurvey()
        {
            objSqlCommand = new SqlCommand();
            objclsConnection = new clsConnection();

            objSqlCommand = new SqlCommand("USP_tblWebinarSurvey_Insert");
        ...
        public DataTable SelectWebinarSurvey()
        {
            DataSet ds = new DataSet();
            objSqlCommand = new SqlCommand();
            objclsConnection = new clsConnection();

            objSqlCommand = new SqlCommand("USP_tblWebinarSurvey_Select");
            objSqlCommand.CommandType = CommandType.StoredProcedure;
